        ...
        >
          <div class="flex flex-col gap-5">
            <div class="flex items-center justify-between">
              <span class="font-ui font-bold text-brown-900 dark:text-beige-100 uppercase tracking-widest text-sm">
                Settings
              </span>
            </div>
            ...
            <div class="flex flex-col gap-2">
              <span class="text-xs font-ui uppercase tracking-wider text-brown-500 dark:text-beige-400 font-semibold">
                Appearance
              </span>
            ...
            <div class="flex flex-col gap-2">
              ...
              <div class="flex bg-beige-50 dark:bg-brown-900 rounded-md p-1 border border-beige-200 dark:border-brown-700">
                <button class="flex-1 flex justify-center items-center py-1.5 text-xs font-semibold rounded-md transition-colors bg-white dark:bg-brown-800 text-brown-900 dark:text-beige-100 shadow-sm">
                  En
                </button>
                <button
                  disabled
                  class="flex-1 flex justify-center items-center py-1.5 text-xs font-semibold rounded-md transition-colors text-brown-600 dark:text-beige-400 cursor-not-allowed"
                >
                  中
                </button>
              </div>
            ...
            <div class="flex flex-col gap-3">
              ...
              <Show
                when={!loading()}
                fallback={
                  <p class="text-sm text-brown-600 dark:text-beige-400 flex items-center gap-2">
                ...
                >
                  <div class="flex flex-col gap-2">
                    <div class="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-beige-50 dark:bg-brown-900 border border-beige-200 dark:border-brown-700">
                      ...
                      >
                        <Show when={!profile()?.avatar}>{getInitial()}</Show>
                      </div>
